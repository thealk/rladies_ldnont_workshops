...
%     - All pre-body text (abstract, acknowledgements, etc) will be defined in doc_preface.tex
...
{\centering \includegraphics{_main_files/figure-latex/calsugsPlot-1} 
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/figlabel-1.pdf}
\caption{\label{fig:figlabel}A nice figure caption}
\end{figure}

See Table @ref(tab:calsugs\_tab).

\textbackslash begin\{table\}{[}t{]}

\textbackslash caption\{(\#tab:calsugs\_tab)Calories and sugars for each beverage.\}
\centering
...
\includegraphics{_main_files/figure-latex/fatPlot-1.pdf}
...
\hypertarget{this-is-another-results-section}{%
\section{This is another results section}\label{this-is-another-results-section}}
