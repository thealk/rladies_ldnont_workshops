...
- source `helper.R`
- write some text
- cite another source from `references.bib`
...
## Exercise 5. Edit the front matter {#ex5}

1. Open `parameters/doc_preface.tex`
  - Rewrite the abstract or acknowledgements section.
2. Open `parameters/preamble.tex`
  - Find the fields where I've specified my name, and edit them to include your own
3. Recompile the dissertation.
