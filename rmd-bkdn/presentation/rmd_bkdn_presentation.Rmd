...
We will create the following files:
  ...
  - Manuscript 1 (starwars_manuscript1.Rmd)
  - Manuscript 2 (starwars_manuscript2.Rmd)
...
## Note: helper.R vs .RData
If your helper script takes a long time to run, you may instead find it useful to save its output to an .RData file:
...
|:-------------------------:|:--------------------------------:|
|            data           | starbucks_drinkMenu_expanded.csv |
|       helper script or .Rdata       | helper.R or starwars.RData[^433]                         |
...
[^433]: If my helper script contains a lot of computations that I don't want to run again, I can save the output as an .RData file and load that in the manuscript instead of sourcing the .R file.
...
## Specific journal templates for R Markdown
- https://github.com/rstudio/rticles
- [Papaja](https://crsh.github.io/papaja_man/introduction.html): APA manuscripts with R Markdown
