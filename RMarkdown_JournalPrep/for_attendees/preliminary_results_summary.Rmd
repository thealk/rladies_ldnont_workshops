...
### OMG ANOTHER plot!
- Here we are making a plot from scratch (i.e., we're not calling a variable from helper.R)
- Therefore, we don't need to assign it a value; we can just include the code for the plot
